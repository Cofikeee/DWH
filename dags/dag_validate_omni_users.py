...
async def validate_and_fetch_users():
    ...
    2. Обрабатывает каждую такую дату обращаясь к fetch_and_process_users с флагом backfill=True.
    3. После окончания работы fetch_and_process_users еще раз проверяет даты в логах бд.
