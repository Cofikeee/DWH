...
async def main():
    ...
    logger = fl.setup_logger('dag_collect_ten_app_type_month')
    logger.info('------------------------------------------------')
    logger.info('Начало работы DAG dag_collect_ten_app_type_month')
    schema_name = 'dwh_ten'
    table_name = 'agg_e_app_type_m'
